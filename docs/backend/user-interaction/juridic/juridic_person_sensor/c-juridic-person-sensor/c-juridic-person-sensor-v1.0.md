# c-sensor-juridic-person - 1.0.0

Content-Type: application/jsom

Orquestrado por: Orch-user-sensor-interaction

Acessado por (Rota interna): POST /access/v1/c-sensor-juridic-person

### Descrição
    Serviço responsável por criar o sensor de um cliente pessoa jurídica.
