# u-sensor-unique-person - 1.0.0

Content-Type: application/jsom

Orquestrado por: Orch-user-sensor-interaction

Acessado por (Rota interna): PATCH /access/v1/u-sensor-unique-person

### Descrição
    Serviço responsável por atualizar o sensor de um cliente pessoa física.
...
```bash
    PATCH http://server:port/v1/u-sensor-unique-person
