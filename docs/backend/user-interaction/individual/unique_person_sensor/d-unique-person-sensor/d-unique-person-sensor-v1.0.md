# d-sensor-unique-person - 1.0.0

Content-Type: application/jsom

Orquestrado por: Orch-user-sensor-interaction

Acessado por (Rota interna): DELETE /access/v1/d-sensor-unique-person

### Descrição
    Serviço responsável por excluir a sensor de um cliente pessoa física.
...
```bash
    DELETE http://server:port/v1/d-sensor-unique-person
