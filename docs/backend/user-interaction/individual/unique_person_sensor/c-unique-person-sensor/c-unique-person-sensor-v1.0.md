# c-sensor-unique-person - 1.0.0

Content-Type: application/jsom

Orquestrado por: Orch-user-sensor-interaction

Acessado por (Rota interna): POST /access/v1/c-sensor-unique-person

### Descrição
    Serviço responsável por criar o sensor de um cliente pessoa física.
