# r-all-cam-unique-person - 1.0.0

Content-Type: application/jsom

Orquestrado por: Orch-user-cam-interaction

Acessado por (Rota interna): POST /access/v1/r-all-cam-unique-person

### Descrição
    Serviço responsável por retornar dados de uma câmera de um cliente pessoa física.
...
```bash
    POST http://server:port/v1/r-all-cam-unique-person
