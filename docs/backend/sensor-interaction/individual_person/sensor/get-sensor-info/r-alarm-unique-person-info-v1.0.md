# r-alarm-unique-person-info - 1.0.0

Content-Type: application/jsom

Orquestrado por: Orch-user-sensor-interaction

Acessado por (Rota interna): POST /access/v1/r-alarm-unique-person-info

### Descrição
    Serviço responsável por retornar informações de sensor de um cliente pessoa física.
...
| alarm_description           | Descrição da câmera                | Sim                |  string              |  -     |
| alarm_model                 | Modelo da câmera                   | Sim                |  string              |  -     |
