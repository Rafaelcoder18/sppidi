...
serviceName = os.environ.get('SVC-NAME', 'c-condominium')
...
@app.route('/access/v1/c-condominium', methods=['POST'])
def svc_r_cam_info():
    ...
    try:
        cursor.execute(f"INSERT INTO condominium VALUES ('{client_id}', '{condominium_id}', '{first_contact_name}', '{first_contact_phone_numer}', '{second_contact_name}', '{second_contact_phone_numer}', '{client_id}', '{contract_id}', '{user_name}', '{user_password}', '{zip_code}', '{address_number}')")
        db_connection.commit()
        doc = {
            'timestamp': datetime.now(),
            'environment': 'b-prd',
            'text': f"INSERT INTO condominium VALUES ('{client_id}', '{condominium_id}', '{first_contact_name}', '{first_contact_phone_numer}', '{second_contact_name}', '{second_contact_phone_numer}', '{client_id}', '{contract_id}', '{user_name}', '{user_password}', '{zip_code}', '{address_number}')",
            'tid': message_id,
            'serviceName': serviceName,
        }
        thread = threading.Thread(target=send_logs_es, args=(doc,))
